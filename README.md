...
GraphRAG-lite는 full Microsoft GraphRAG가 아니라, Course Pack 내부의 course structure, concept edge, evidence chunk를 retrieval에 활용하는 lightweight graph-augmented retrieval입니다.

## Key Features

- Multi-document Course Pack ingestion
- Source-grounded Q&A
- LightRAG-style Dual-Level Retrieval Router via `mode="auto"`
- Hierarchical Summary Retrieval for global overview questions
- Course Graph Retrieval via GraphRAG-lite `local_graph`
...
| Retrieval | Single-document RAG | Auto-routed chunk, hierarchical summary, and course graph retrieval across Course Pack sources |
| Graph | None or visualization-focused | Course graph retrieval using structure nodes, concept edges, and evidence chunks |
...
- [LightRAG-style Router](docs/LIGHTRAG_ROUTER.md)
- [Hierarchical Retrieval](docs/HIERARCHICAL_RETRIEVAL.md)
